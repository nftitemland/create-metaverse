...
const mintSlime = async ({
  ...
  try {
    const params = [
      {
        ...
        value: hexEncode(String(mintPrice * 1000000000000000000)),
        // gas: "0x76c0", // 30400
    ...
    setStatus(
      <span>
        {`PoiPoi (or Gurr) successfully minted. Ethereum transaction ID: `}
    ...
    setStatus(`PoiPoi (or Gurr) not minted: ${errorMessage}`);
  }
